...
describe('Live Node Chat Server', function() {
  it('Should respond to GET requests for /log with a 200 status code', function(done) {
    request('http://127.0.0.1:3010/classes/messages', function(error, response, body) {
  ...
  it('Should accept POST requests to /send', function(done) {
    var requestParams = {method: 'POST',
      uri: 'http://127.0.0.1:3010/classes/messages',
      json: {
        username: 'Jono',
  ...
  it('Should 404 when asked for a nonexistent file', function(done) {
    request('http://127.0.0.1:3010/arglebargle', function(error, response, body) {
